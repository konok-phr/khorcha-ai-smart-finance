  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'আসসালামু আলাইকুম! 👋 আমি HisabAI - আপনার স্মার্ট AI অ্যাসিস্ট্যান্ট।\n\nআমি আপনার খরচ এবং আয় যোগ করতে সাহায্য করতে পারি। বলুন আপনি কী যোগ করতে চান?\n\n🗣️ উদাহরণ:\n• "৫০০ টাকা রিকশা খরচ"\n• "বিকাশে ১০০০ টাকা পেলাম"\n• "উবার ১৫০"\n\n📸 রিসিটের ছবি দিলেও চলবে!',
    }
  ]);
